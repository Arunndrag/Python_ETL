...
# data = wget https://cf-courses-data.s3.us.cloud-object-storage.appdomain.cloud/IBMDeveloperSkillsNetwork-PY0221EN-SkillsNetwork/labs/module%206/Lab%20-%20Extract%20Transform%20Load/data/datasource.zip 
...
def extract_from_xml(file_to_process):
    ...
    for cars in root:
        ...
        year_of_manufacture = cars.find("year_of_manufacture").text
